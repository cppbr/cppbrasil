...
void Nota::configurar()
{
    ...
    m_nfe->configuracoes->set_IdCSC("");
    m_nfe->configuracoes->set_CSC("");
...
void Nota::ide()
{
    ...
    m_nfe->notafiscal->NFe->obj->infNFe->ide->set_tpImp(ConvNF::strToTpImp("1")); //TpImp::Retrato
